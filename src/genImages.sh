...
ssh -x -l d103 172.25.26.191 "cd Dat10/src/;python extractImages.py compareVehicles $GPSDATA | gnuplot"
scp d103@172.25.26.191:Dat10/src/images/compareVehicles.png $PREFIX"_images"/compareVehicles.png
