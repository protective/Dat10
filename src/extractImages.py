...
if TYPE == 'km_pr_l':
	...
	print """plot 
		'data/idle2.csv' using 1:4 t \"High\" w filledcurves x1 linestyle 4, 
		'data/idle2.csv' using 1:3 t \"Medium\" w filledcurves x1 linestyle 3, 
		'data/idle2.csv' using 1:2 t \"Low\" w filledcurves x1 linestyle 2"""
