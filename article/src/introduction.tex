...
%TODO: Maybe remove this sentence
...
Some of these advice, especially \ref{intro.advice.gear} through \ref{intro.advice.deceleration}, needs practice, while other advices, especially \ref{intro.advice.idling} though \ref{intro.advice.cruise} can be implemented without much practise. %TODO: refomulate
