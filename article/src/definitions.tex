\section{Defintions}
\subsection{Trips}
Motoren skal være tændt, e.g. rpm > 0
ny tur slukket motor i 2 min
En tur skal have min X observationer per minute
...
We see that the curve flattens around 100 seconds, and we therefore choose this as the timeframe. %TODO: Do tests to explain why 100 seconds 
\begin{figure}[htb]
\centering
