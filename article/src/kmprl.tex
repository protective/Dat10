...
One could also have a class containing trips with more than 15 km/l but only 43 trips will be in this class. %CHECK
\begin{figure}[htb]
\centering
\includegraphics[width=0.5\textwidth]{../src/d_images/kmlTrips.png}
